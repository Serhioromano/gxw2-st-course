...
Прежде чем мы начнем разбирать интерфейс пользователя и как с ним взаимодействовать, запомните термины которые я буду использовать.
...
Для тех кто всегда стремится к максимальной продуктивности будет полезно знать что по этому меню можно перемещаться не касаясь мышки. По сути это работает в любой программе. Например в Microsoft Office или Photoshop. Скорей всего вы это уже знаете, но для тех кто не знает, если нажать и отпустить клавишу ++alt++ на клавиатуре, то первый элемент меню подсветиться. Далее можно при помощи клавиш ++up++, ++down++, ++right++, ++left++ перемещаться по элементам меню, и клавишей ++enter++ выполнить команду меню. Если же мы передумали, и не хотим завершать нашу навигацию вызовом команды, то можем прервать навигацию по меню клавишей ++esc++.

Есть еще более быстрый способ. Обратите внимание что некоторые буквы в меню элемента подчеркнуты. Если нажать и отпустить клавишу ++alt++ на клавиатуре, а потом подчеркнутую букву, то сразу перейдем в это меню. Например мы хотим попасть в меню *Tools*, там подчеркнута буква Т. Нажмем клавишу клавишу ++alt++ а затем клавишу буквы ++"T"++ на клавиатуре, и мы перешли в меню *Tools*. В выпавшем меню, мы видим что в каждой команде тоже есть подчеркнутая буква. Например мы хотим открыть настройки *Options...* это буква О. Нажмем клавишу ++"О"++ и у нас откроются окно настройки.

Со временем вы выучите последовательности и будете быстро ими пользоваться выполняя команды не отрывая рук от клавиатуры. Попробуйте сами быстро нажать последовательность клавиш ++alt+"T"+"O"++. Буквально секунда и окно открыто. А если взять в расчет что меню GX Works 2 содержи все команды которые только возможны в этой программе, включая все что есть в панели инструментов, то можно не настраивать быстрые клавиши, а просто запомнить эти последовательности. Быстрые клавиши отличаются тем что это одновременное нажатие комбинации клавиш, а проход по меню это последовательное нажатие клавиш одной за другой. Быстрые клавиши не удобны тем, что если ими не пользоваться постоянно, то можно быстро забыть комбинацию, а тут даже если забыл комбинацию, всегда можно медленно пройти по меню через клавишу ++alt++ и вспомнить последовательность.
...
Это то что у меня постоянно открыто. Теперь навигатор инструкций я активирую и перетаскиваю в лево от рабочей области. И потом его закрываю. Пользуюсь я им очень редко, постоянно оно не открыто, если я открою навигатор снова, он откроется именно в этой позиции. И мне это удобно. Открыл, нашел, закрыл.
